  ...
  return (
    <>
      {loading ? (
        ...
        <>
          <div className="flex justify-center sm:justify-start items-center mt-4 px-4 sm:px-12">
          ...
          <div>
            {/* flex-wrap + responsive gap */}
            <div className="m-4 sm:m-12 flex items-center justify-center sm:justify-start flex-wrap gap-4">
              {recipes?.map((recipe) => {
                ...
                return (
                  <div
                    ...
                    className="cursor-pointer bg-white/20 rounded-xl shadow hover:shadow-lg transition overflow-hidden h-full flex flex-col w-[250px]"
                  >
                    <img
